#!/usr/bin/env bash
#
# convert.sh — Convert agent .md files into tool-specific formats (Arabic edition)
#
...
# source：https://github.com/jnMetaCode/agency-agents-ar
#
